        ...
        <div class="tab-pane active in" id="home">
          <form id="tab" class="form-horizontal">
            <div class="control-group">
              文章标题:
              <input type="text" id="add_article_title" value="{{.Title}}" class="input-xlarge">
              <input type="hidden" id="add_article_id" value="{{.Id}}">
              <input type="hidden" id="add_article_origin_title" value="{{.Title}}">
              <span class="text-error" id="add_article_prompt_info"></span>
            </div>
            <div class="control-group">
              选择类别:
              <select id="select_category" value="{{.CategoryId}}"></select>
            </div>
...
{{end}}
  ...
  <script type="text/javascript" src="/static/js/controller/edit_article.js"></script>